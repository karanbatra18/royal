...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('membership.store') }}" autocomplete="off" class="form-horizontal">
            @csrf

            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Add Membership') }}</h4>
                 ...
                 <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                        <textarea class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" id="input-description">{{ old('description') }}</textarea>
                  ...
                  <div class="col-sm-7">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('cost') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('cost') ? ' is-invalid' : '' }}" name="cost" id="input-cost" type="number" placeholder="Total Cost" required="true" aria-required="true" value="{{ old('cost') }}"/>
                        @if ($errors->has('cost'))
                   ...
                   <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('total_profile_limit') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('total_profile_limit') ? ' is-invalid' : '' }}" name="total_profile_limit" id="input-total_profile_limit" type="number" placeholder="Total Profile Limit" required="true" aria-required="true" value="{{ old('total_profile_limit') }}"/>
                   ...
                   <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('daily_profile_limit') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('daily_profile_limit') ? ' is-invalid' : '' }}" name="daily_profile_limit" id="input-daily_profile_limit" type="number" placeholder="Daily Profile Limit" required="true" aria-required="true" value="{{ old('daily_profile_limit') }}"/>
                   ...
                   <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('total_contact_limit') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('total_contact_limit') ? ' is-invalid' : '' }}" name="total_contact_limit" id="input-total_contact_limit" type="number" placeholder="Total Contact Limit" required="true" aria-required="true" value="{{ old('total_contact_limit') }}"/>
                   ...
                   <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('daily_contact_limit') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('daily_contact_limit') ? ' is-invalid' : '' }}" name="daily_contact_limit" id="input-daily_contact_limit" type="number" placeholder="Daily Contact Limit" required="true" aria-required="true" value="{{ old('daily_contact_limit') }}"/>
